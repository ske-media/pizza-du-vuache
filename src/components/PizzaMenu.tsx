      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="inline-flex rounded-lg bg-white shadow-sm p-1">
            {['pizzas', 'boissons', 'desserts'].map((tab) => (
              <button
                key={tab}
                onClick={() => {
                  setActiveTab(tab as 'pizzas' | 'boissons' | 'desserts');
                  if (tab === 'pizzas') {
                    setActivePizzaCategory(menuData.pizzas[0].category);
                  }
                }}
        ...
        <div className="mt-16 text-center space-y-4">
          <button
            ...
            className="inline-flex items-center px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold rounded-full transition-colors duration-300 shadow-lg hover:shadow-xl"
          >
